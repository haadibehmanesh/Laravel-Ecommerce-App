...
<script>
  ...
  gtag('config', 'UA-129893987-1');
    ...
    <meta name="og:description" content=" همه تخفیف های روز شیراز تا سقف ۹۰٪ برای شیرازی های عزیز در سایت تخفیف و خریدگروهی بن اینجا "/>
...
<div class="card">
        <div class="card-header">
                <a href="{{ route('shop.show', $featured->id) }}" class="" title="{{ $featured->name }}"><span class="card-span">{{ $featured->name }}</span></a>
