                            ...
                            <div class="dokan-dash-sidebar">
                                ...
                                <form action="" method="GET" class="dokan-left">
                                    <div class="dokan-form-group">
                                        <label for="from">تاریخ:</label> <input type="text" class="datepicker hasDatepicker" name="order_date" id="order_date_filter" value="">
                                        <input type="submit" name="dokan_order_filter" class="dokan-btn dokan-btn-sm dokan-btn-danger dokan-btn-theme" value="فیلتر کردن">
                                ...
                                <form action="" method="POST" class="dokan-right">
                                    <div class="dokan-form-group">
                                        <input type="hidden" id="dokan_vendor_order_export_nonce" name="dokan_vendor_order_export_nonce" value="c004ad6fcb"><input type="hidden" name="_wp_http_referer" value="/takhfifat/dashboard/orders/">            <input type="submit" name="dokan_order_export_all" class="dokan-btn dokan-btn-sm dokan-btn-danger dokan-btn-theme" value="صادرکردن همه">
                                        <input type="submit" name="dokan_order_export_filtered" class="dokan-btn dokan-btn-sm dokan-btn-danger dokan-btn-theme" value="صدور فیلتر شده">
                                ...
                                <table class="dokan-table dokan-table-striped">
                                    ...
                                    <tbody>
                                                ...
                                                <td class="dokan-order-status" data-title="وضعیت">
                                                    <span class="dokan-label dokan-label-info">درحال پردازش</span>                    </td>
                                                <td class="dokan-order-customer" data-title="مشتری">
                                                    امیر غلامی                    </td>
                                                ...
                                                <td class="dokan-order-total" data-title="جمع کل سفارش">
                                                    <span class="woocommerce-Price-amount amount">۲۵۰,۰۰۰&nbsp;<span class="woocommerce-Price-currencySymbol">تومان</span></span>                    </td>
                                                <td class="dokan-order-status" data-title="وضعیت">
                                                    <span class="dokan-label dokan-label-success">تکمیل شده</span>                    </td>
                                                <td class="dokan-order-customer" data-title="مشتری">
                                                    امیر غلامی                    </td>
                                                <td class="dokan-order-date" data-title="تاریخ">
