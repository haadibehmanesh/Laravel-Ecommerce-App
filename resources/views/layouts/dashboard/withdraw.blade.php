...
<html lang="fa_IR">
        <head>
            ...
            <style type="text/css">/** Mega Menu CSS Disabled **/</style>
                ...
                <link href="{{asset('wp-content/themes/takhfifat/stylefc99.css?ver=2.8')}}" rel="stylesheet">
...
<ul class="dokan-dashboard-menu"><li class="dashboard"><a href="{{ route('merchantpanel.index')}}"><i class="fa fa-tachometer"></i> پیشخوان</a></li><li class="products"><a><i class="fa fa-briefcase"></i><span onclick="products(event)">بن های باطل شده</span> </a></li><li class="active withdraw"><a href="#"><i class="fa fa-upload"></i> درخواست تسویه حساب</a></li><li class="settings"><a href="#"><i class="fa fa-cog"></i> تنظیمات</a></li><li class="dokan-common-links dokan-clearfix">
        ...
        <h1 class="entry-title">درخواست تسویه حساب</h1>
                ...
                <div class="entry-content">
                    ...
                    <strong>موجودی فعلی: <span class="woocommerce-Price-amount amount">{{toPersianNum(number_format($totalRevenue))}}&nbsp;<span class="woocommerce-Price-currencySymbol">تومان</span></span>
                        {{-- &nbsp;حداقل مقدار برداشت: <span class="woocommerce-Price-amount amount">۵۰,۰۰۰&nbsp;<span class="woocommerce-Price-currencySymbol">تومان</span></span> --}}</strong>
    </div>
    <ul class="list-inline subsubsub">
       ...
       {{-- <li>
            <a href="http://demo.onliner.ir/takhfifat/dashboard/withdraw/?type=approved">درخواست‌های تاییدشده</a>
        </li>
        <li>
