...
<li id="menu-item-166" class="menu-item menu-item-type-post_type menu-item-object-page current_page_parent menu-item-166"><a href="../../shop/index.html">فروشگاه</a></li>
            </ul>
            <!--phone-->
				...
				<script>
                    ...
                    jQuery(function() {
                        ...
                        jQuery('.countdown_single_product').countdown({
                            ...
                            <del><span class="woocommerce-Price-amount amount">{{$product->price}}&nbsp;<span class="woocommerce-Price-currencySymbol">&#x062A;&#x0648;&#x0645;&#x0627;&#x0646;</span></span></del> <ins><span class="woocommerce-Price-amount amount">20,000&nbsp;<span class="woocommerce-Price-currencySymbol">&#x062A;&#x0648;&#x0645;&#x0627;&#x0646;</span></span></ins>
							</span>
...
<div class="related_product box_single">
    ...
    @forelse ($mightAlsoLike as $mightAlsoLike)
    
		<div class="col-lg-3 col-md-3 col-sm-6">
            <div class="box_offer box_offer_mini">
				<div class="time_out">
                    <i class="fa fa-clock-o"></i>
                    <ul class="deal-timer countdownntgiu"></ul>
                    <script>
				    jQuery(function() {
                        var endDate = "2018-12-25 23:59:00";
                        jQuery('.countdownntgiu').countdown({
                            date: endDate,
                            render: function(data) {
                                if ( ! data.sec  ) { data.sec = 0 };
								var days = toPersianNum(data.days);
                ...
                <a href="{{ route('shop.show', $mightAlsoLike->slug) }}" title="{{ $mightAlsoLike->name }}"><img src="{{ productImage($mightAlsoLike->image) }}" title="{{ $mightAlsoLike->name }}"></a>
                <!-- Discount -->
                ...
                <div class="Information">
                    <h2 class="ellipsis"><a href="{{ route('shop.show', $mightAlsoLike->slug) }}">{{ $mightAlsoLike->name }}</a></h2>
                    <span class="price"><del><span class="woocommerce-Price-amount amount">{{ $mightAlsoLike->price }}&nbsp;<span class="woocommerce-Price-currencySymbol">&#x062A;&#x0648;&#x0645;&#x0627;&#x0646;</span></span></del> <ins><span class="woocommerce-Price-amount amount">690,000&nbsp;<span class="woocommerce-Price-currencySymbol">&#x062A;&#x0648;&#x0645;&#x0627;&#x0646;</span></span></ins></span>
                </div>
            </div>
        </div>    
        @empty
