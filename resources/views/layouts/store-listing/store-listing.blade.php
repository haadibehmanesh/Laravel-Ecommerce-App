...
<!-- Mirrored from localhost/takhfiftest/store-listing/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Jun 2018 08:09:30 GMT -->
...
<link rel="alternate" type="application/json+oembed" href="../wp-json/oembed/1.0/embed9e23.json?url=http%3A%2F%2Flocalhost%2Ftakhfiftest%2Fstore-listing%2F" />
<link rel="alternate" type="text/xml+oembed" href="../wp-json/oembed/1.0/embed7a37?url=http%3A%2F%2Flocalhost%2Ftakhfiftest%2Fstore-listing%2F&amp;format=xml" />
...
<body class="rtl page-template-default page page-id-13 mega-menu-main-menu dokan-theme-takhfifat">
    <!----- Top Menu
-------------------->
...
<!-- / Nav -->    <!--wrapper-->
    ...
    <div class="container">
        <div class="row">
                        <ol class="breadcrumb"><a href="http://localhost/takhfiftest">خانه</a> &#47; تمامی فروشندگان</ol>            <div class="post-content-page">
                                        
                    <!--title & discount & views-->
                    <div class="title_post">
                        <h1>تمامی فروشندگان</h1>
                    </div>
                            <div class="dokan-seller-listing">

    
        <form role="search" method="get" class="dokan-seller-search-form" action="#">
            <input type="search" id="search" class="search-field dokan-seller-search" placeholder="جستجوی فروشنده &hellip;" value="" name="dokan_seller_search" title="جستجوی فروشنده &hellip;" />
            <input type="hidden" id="pagination_base" name="pagination_base" value="page/%25.html#%/" />
            <input type="hidden" id="nonce" name="nonce" value="041accf1b4" />
                    ...
                    <li class="dokan-single-seller woocommerce coloum-3 no-banner-img">
                        <div class="store-wrapper">
                            <div class="store-content">
                                <div class="store-info" style="background-image: url( '../wp-content/plugins/dokan-lite/assets/images/default-store-banner.png');">
                                    <div class="store-data-container">
                                        ...
                                        <div class="store-data">
                                            <h2><a href="../store/pazzle/index.html">پازل</a></h2>

                                            
                                                                                            <p class="store-address"><span class='street_2'> آدرس کامل فروشگاه در اینجا درج میگردد.,</span></p>
                                            
                                                                                            <p class="store-phone">
                                                    <i class="fa fa-phone" aria-hidden="true"></i> 021-12345678                                                </p>
                            ...
                            <div class="store-footer">
                                <div class="seller-avatar">
                                    <img alt='' src='../wp-content/uploads/2017/05/solution-300x225-150x150.png' srcset='http://localhost/takhfiftest/wp-content/uploads/2017/05/solution-300x225-150x150.png 2x' class='avatar avatar-150 photo' height='150' width='150' />                                </div>
                                <a href="../store/pazzle/index.html" class="dokan-btn dokan-btn-theme">مشاهده‌ی فروشگاه</a>
                            ...
                            <div class="store-content">
                                <div class="store-info" style="background-image: url( '../wp-content/plugins/dokan-lite/assets/images/default-store-banner.png');">
                                    <div class="store-data-container">
                                        ...
                                        <div class="store-data">
                                            <h2><a href="../store/booliz/index.html">سید محسن فاطمی</a></h2>

                                                                                            <div class="star-rating dokan-seller-rating" title="<br />
<b>Warning</b>:  sprintf(): Too few arguments in <b>C:\xampp5\htdocs\takhfiftest\wp-content\plugins\dokan-lite\templates\store-lists-loop.php</b> on line <b>34</b><br />
">
                                                    <span style="width: 99%">
                                                        <strong class="rating">5.00</strong> out of 5
                                                                                            ...
                                                                                            <p class="store-phone">
                                                    <i class="fa fa-phone" aria-hidden="true"></i> 021-65498721                                                </p>
                            ...
                            <div class="store-footer">
                                <div class="seller-avatar">
                                    <img alt='' src='../wp-content/uploads/2017/05/icon_32-150x150.png' srcset='http://localhost/takhfiftest/wp-content/uploads/2017/05/icon_32-150x150.png 2x' class='avatar avatar-150 photo' height='150' width='150' />                                </div>
                                <a href="../store/booliz/index.html" class="dokan-btn dokan-btn-theme">مشاهده‌ی فروشگاه</a>
                    ...
                    <li class="dokan-single-seller woocommerce coloum-3 no-banner-img">
                        <div class="store-wrapper">
                            <div class="store-content">
                                <div class="store-info" style="background-image: url( '../wp-content/plugins/dokan-lite/assets/images/default-store-banner.png');">
                                    <div class="store-data-container">
                                        ...
                                        <div class="store-data">
                                            <h2><a href="../store/zhaket/index.html">سید علی علوی</a></h2>

                                            
                                            
                                                                                            <p class="store-phone">
                                                    <i class="fa fa-phone" aria-hidden="true"></i> 021-1526589                                                </p>
                            ...
                            <div class="store-footer">
                                <div class="seller-avatar">
                                    <img alt='' src='../wp-content/uploads/2017/05/Fluxbox-logo-copy-150x150.png' srcset='http://localhost/takhfiftest/wp-content/uploads/2017/05/Fluxbox-logo-copy-150x150.png 2x' class='avatar avatar-150 photo' height='150' width='150' />                                </div>
                                <a href="../store/zhaket/index.html" class="dokan-btn dokan-btn-theme">مشاهده‌ی فروشگاه</a>
                    ...
                    <li class="dokan-single-seller woocommerce coloum-3 no-banner-img">
                        <div class="store-wrapper">
                            <div class="store-content">
                                <div class="store-info" style="background-image: url( '../wp-content/plugins/dokan-lite/assets/images/default-store-banner.png');">
                                    <div class="store-data-container">
                                        ...
                                        <div class="store-data">
                                            <h2><a href="../store/zarrin/index.html">محمد کریم پور</a></h2>

                                            
                                            
                                                                                            <p class="store-phone">
                                                    <i class="fa fa-phone" aria-hidden="true"></i> 021-5648453                                                </p>
                            ...
                            <div class="store-footer">
                                <div class="seller-avatar">
                                    <img alt='' src='../wp-content/uploads/2017/05/logo2-150x150.png' srcset='http://localhost/takhfiftest/wp-content/uploads/2017/05/logo2-150x150.png 2x' class='avatar avatar-150 photo' height='150' width='150' />                                </div>
                                <a href="../store/zarrin/index.html" class="dokan-btn dokan-btn-theme">مشاهده‌ی فروشگاه</a>
                    ...
                    <li class="dokan-single-seller woocommerce coloum-3 no-banner-img">
                        <div class="store-wrapper">
                            <div class="store-content">
                                <div class="store-info" style="background-image: url( '../wp-content/plugins/dokan-lite/assets/images/default-store-banner.png');">
                                    <div class="store-data-container">
                                        ...
                                        <div class="store-data">
                                            <h2><a href="../store/wwwl/index.html">محمد مهدی قنبریان گوارشکی</a></h2>

                                            
                                            
                                                                                            <p class="store-phone">
                                                    <i class="fa fa-phone" aria-hidden="true"></i> 021-1654985                                                </p>
                            ...
                            <div class="store-footer">
                                <div class="seller-avatar">
                                    <img alt='' src='../wp-content/uploads/2017/05/Dove-logo-350x302-150x150.png' srcset='http://localhost/takhfiftest/wp-content/uploads/2017/05/Dove-logo-350x302-150x150.png 2x' class='avatar avatar-150 photo' height='150' width='150' />                                </div>
                                <a href="../store/wwwl/index.html" class="dokan-btn dokan-btn-theme">مشاهده‌ی فروشگاه</a>
                    ...
                    <li class="dokan-single-seller woocommerce coloum-3 no-banner-img">
                        <div class="store-wrapper">
                            <div class="store-content">
                                <div class="store-info" style="background-image: url( '../wp-content/plugins/dokan-lite/assets/images/default-store-banner.png');">
                                    <div class="store-data-container">
                                        ...
                                        <div class="store-data">
                                            <h2><a href="../store/chargon/index.html">سید یاسین غیاثی</a></h2>

                                            
                                            
                                                                                            <p class="store-phone">
                                                    <i class="fa fa-phone" aria-hidden="true"></i> 021-46513258                                                </p>
                            ...
                            <div class="store-footer">
                                <div class="seller-avatar">
                                    <img alt='' src='../wp-content/uploads/2017/05/famous_brand_logo_secret_meaning_nbc-copy-150x150.png' srcset='http://localhost/takhfiftest/wp-content/uploads/2017/05/famous_brand_logo_secret_meaning_nbc-copy-150x150.png 2x' class='avatar avatar-150 photo' height='150' width='150' />                                </div>
                                <a href="../store/chargon/index.html" class="dokan-btn dokan-btn-theme">مشاهده‌ی فروشگاه</a>
                    ...
                    <li class="dokan-single-seller woocommerce coloum-3 no-banner-img">
                        <div class="store-wrapper">
                            <div class="store-content">
                                <div class="store-info" style="background-image: url( '../wp-content/plugins/dokan-lite/assets/images/default-store-banner.png');">
                                    <div class="store-data-container">
                                        ...
                                        <div class="store-data">
                                            <h2><a href="../store/omadis/index.html">مرتضی پیروی</a></h2>

                                            
                                            
                                                                                            <p class="store-phone">
                                                    <i class="fa fa-phone" aria-hidden="true"></i> 021-65459845                                                </p>
                            ...
                            <div class="store-footer">
                                <div class="seller-avatar">
                                    <img alt='' src='../wp-content/uploads/2017/05/avg-technologhies-logo-copy-150x150.png' srcset='http://localhost/takhfiftest/wp-content/uploads/2017/05/avg-technologhies-logo-copy-150x150.png 2x' class='avatar avatar-150 photo' height='150' width='150' />                                </div>
                                <a href="../store/omadis/index.html" class="dokan-btn dokan-btn-theme">مشاهده‌ی فروشگاه</a>
                    ...
                    <li class="dokan-single-seller woocommerce coloum-3 no-banner-img">
                        <div class="store-wrapper">
                            <div class="store-content">
                                <div class="store-info" style="background-image: url( '../wp-content/plugins/dokan-lite/assets/images/default-store-banner.png');">
                                    <div class="store-data-container">
                                        ...
                                        <div class="store-data">
                                            <h2><a href="../store/talash/index.html">سید رسول هاشم آبادی</a></h2>

                                            
                                            
                                                                                            <p class="store-phone">
                                                    <i class="fa fa-phone" aria-hidden="true"></i> 201-4656232                                                </p>
                            ...
                            <div class="store-footer">
                                <div class="seller-avatar">
                                    <img alt='' src='../wp-content/uploads/2017/05/butterfly-business-logo-E9DA2A9FF250-seeklogo.com-copy-150x150.png' srcset='http://localhost/takhfiftest/wp-content/uploads/2017/05/butterfly-business-logo-E9DA2A9FF250-seeklogo.com-copy-150x150.png 2x' class='avatar avatar-150 photo' height='150' width='150' />                                </div>
                                <a href="../store/talash/index.html" class="dokan-btn dokan-btn-theme">مشاهده‌ی فروشگاه</a>
                    ...
                    <li class="dokan-single-seller woocommerce coloum-3 no-banner-img">
                        <div class="store-wrapper">
                            <div class="store-content">
                                <div class="store-info" style="background-image: url( '../wp-content/plugins/dokan-lite/assets/images/default-store-banner.png');">
                                    <div class="store-data-container">
                                        ...
                                        <div class="store-data">
                                            <h2><a href="../store/zagros/index.html">محمد نجاتیان یزدیان</a></h2>

                                            
                                                                                            <p class="store-address"><span class='street_2'> آدرس کامل فروشگاه در اینجا درج میگردد.,</span></p>
                                            
                                                                                            <p class="store-phone">
                                                    <i class="fa fa-phone" aria-hidden="true"></i> 201-6849351                                                </p>
                            ...
                            <div class="store-footer">
                                <div class="seller-avatar">
                                    <img alt='' src='../wp-content/uploads/2017/05/Tizen-Pinwheel-25ght-RGB-copy-150x150.png' srcset='http://localhost/takhfiftest/wp-content/uploads/2017/05/Tizen-Pinwheel-25ght-RGB-copy-150x150.png 2x' class='avatar avatar-150 photo' height='150' width='150' />                                </div>
                                <a href="../store/zagros/index.html" class="dokan-btn dokan-btn-theme">مشاهده‌ی فروشگاه</a>
                    ...
                    <li class="dokan-single-seller woocommerce coloum-3 no-banner-img">
                        <div class="store-wrapper">
                            <div class="store-content">
                                <div class="store-info" style="background-image: url( '../wp-content/plugins/dokan-lite/assets/images/default-store-banner.png');">
                                    <div class="store-data-container">
                                        ...
                                        <div class="store-data">
                                            <h2><a href="../store/dey/index.html">محسن پیوندی</a></h2>

                                            
                                            
                                                                                            <p class="store-phone">
                                                    <i class="fa fa-phone" aria-hidden="true"></i> 021-49865658                                                </p>
                            ...
                            <div class="store-footer">
                                <div class="seller-avatar">
                                    <img alt='' src='../wp-content/uploads/2017/05/Tizen-Pinwheel-On-Light-RGB-150x150.png' srcset='http://localhost/takhfiftest/wp-content/uploads/2017/05/Tizen-Pinwheel-On-Light-RGB-150x150.png 2x' class='avatar avatar-150 photo' height='150' width='150' />                                </div>
                                <a href="../store/dey/index.html" class="dokan-btn dokan-btn-theme">مشاهده‌ی فروشگاه</a>
	...
	<li><a class="next page-numbers" href="page/2/index.html">بعدی &raquo; </a></li>
</ul>
</div></div>
            </div>
</div></div>
...
<div class="widget_wysija_cont shortcode_wysija"><div id="msg-form-wysija-shortcode5b2b5cffc0169-1" class="wysija-msg ajax"></div><form id="form-wysija-shortcode5b2b5cffc0169-1" method="post" action="#wysija" class="widget_wysija shortcode_wysija">
...
<!-- Mirrored from localhost/takhfiftest/store-listing/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Jun 2018 08:09:34 GMT -->
</html>