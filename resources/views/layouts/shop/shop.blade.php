...
<header>
    <div class="container">
        <div class="row">
            ...
            <!--logo-->
                            <div class="logo" ><a href="/" title="سامانه خرید و تخفیف گروهی بن اینجا"></a></div>
...
<!-- / Nav -->    <!--wrapper-->
    <section id="wrapper">
        <div class="container">
            <div class="row">
                <ol class="breadcrumb"><a href="/">خانه</a> &#47; همه پیشنهادها</ol>                <div class="block_gallery_archive">
...
<div class="block_posts box_single">
    ...
    margin: 20px 0;">
        ...
        <h1 style="visibility: hidden;line-height: 0;">همه پیشنهادهای تخفیف بن اینجا در شیراز</h1> 
    </div>   
