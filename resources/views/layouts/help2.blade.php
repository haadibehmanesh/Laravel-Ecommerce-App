            ...
            <div class="container">
                ...
                <div class="post-content">
                    <div>
                        ...
                        <img alt="" src="{{{ asset('img/help1.jpg') }}}" style="float:left; height:100%; width:100%;padding-bottom: 5px;border: 3px solid #f6861f;" class="initial loaded" data-was-processed="true">
                    ...
                    <p style="text-align: justify;">
                         ...
                         <img alt="" src="{{{ asset('img/help2.jpg') }}}" style="float:left; height:100%; width:100%;padding-bottom: 5px;border: 3px solid #f6861f;" class="initial loaded" data-was-processed="true">
                    ...
                    <div>
                            ...
                            <img alt="" src="{{{ asset('img/help3.jpg') }}}" style="float:left; height:100%; width:100%;padding-bottom: 5px;border: 3px solid #f6861f;" class="initial loaded" data-was-processed="true">
                    ...
                    <div>
                            ...
                            <img alt="" src="{{{ asset('img/help4.jpg') }}}" style="float:left; height:100%; width:100%;padding-bottom: 5px;border: 3px solid #f6861f;" class="initial loaded" data-was-processed="true">
...
<div class="widget_wysija_cont shortcode_wysija" style="display:none;"><div id="msg-form-wysija-shortcode5b2b59fce5ec2-1" class="wysija-msg ajax"></div><form id="form-wysija-shortcode5b2b59fce5ec2-1" method="post" action="#wysija" class="widget_wysija shortcode_wysija">
