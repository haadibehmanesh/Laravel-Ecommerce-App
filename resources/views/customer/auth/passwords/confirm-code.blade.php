...
<style type="text/css">/** Mega Menu CSS Disabled **/</style>
    ...
    <link href="{{asset('wp-content/themes/takhfifat/stylefc99.css?ver=4.2')}}" rel="stylesheet">
                        ...
                        @if($item->children->count() > 0)
                                <li class='mega-menu-item mega-menu-item-type-custom mega-menu-item-object-custom mega-menu-item-has-children mega-align-bottom-left mega-menu-megamenu mega-has-icon mega-menu-item-241' id='mega-menu-item-241'><a class=" fa {{$item->icon}}  mega-menu-link" href="{{ route('shop.showCategory', $item->slug) }}" aria-haspopup="true" tabindex="0">{{ $item->name}}</a>
                                    <ul class="mega-sub-menu">
                                        <li class='mega-menu-item mega-menu-item-type-widget widget_sp_image mega-menu-columns-1-of-4 mega-menu-item-widget_sp_image-2' id='mega-menu-item-widget_sp_image-2'><img width="100" height="100" class="attachment-shop_thumbnail" style="max-width: 100%;" srcset="{{ categoryImage($item->image) }}" /></li>                                 <ul class="mega-sub-menu-mob">                                          <li class='mega-menu-item'><a class="mega-menu-link" href="{{ route('shop.showCategory', $item->slug) }}" style="color: #19499c;"> همه {{$item->name}} ها</a></li></ul>
            ...
            <h1>بازیابی رمز ورود</h1>
                ...
                <div class="woocommerce">
                        ...
                        <div class="panel panel-default">
                                <div class="panel-heading"> بازیابی رمز ورود</div>
                                @if($errors->has('notmatch'))
                                <div class="alert alert-danger">
                                        {!! ' شماره همراه وارد شده و کد ارسالی، مطابقت ندارد! ' !!}
                                </div>
                                @endif
                                <div class="panel-body">
                                    ...
                                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/customer/password/reset') }}">
                                        ...
                                        <div class="form-group{{ $errors->has('code') ? ' has-error' : '' }}">
                                            <label for="code" class="col-md-4 control-label">کد ارسالی به شماره شما<span class="required"></span></label>
                                        ...
                                        <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                                            <label for="password" class="col-md-4 control-label">رمز ورود جدید <span class="required"></span></label>
...
<script type='text/javascript' src='{{asset('wp-includes/js/jquery/ui/datepicker.mine899.js?ver=1.11.4')}}'></scrip
...
<script type='text/javascript' src='{{asset('wp-content/plugins/dokan-lite/assets/js/dokanb246.js?ver=2.7.8')}}'></script>
